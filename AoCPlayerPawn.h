...
public:
	...
	/** Visual pickaxe mesh attached to character's right hand during mining. */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Gameplay|Tools")
	UStaticMeshComponent* PickaxeMeshComp;
