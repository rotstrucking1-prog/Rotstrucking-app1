...
public:
	...
	int32 TotalEngagements = 0;

	UFUNCTION(BlueprintCallable, Category = "AoC|NPC|Combat")
	int32 GetTotalEngagements() const { return TotalEngagements; }
...
private:
	...
	public:
	UFUNCTION(BlueprintCallable, Category = "AoC|AI|Combat")
	void EquipBestAvailableWeapon();
