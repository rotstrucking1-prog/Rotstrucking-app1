 ...
 */
UCLASS()
class ARCHITECTOFCREATION_API UAoCBaseAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
 ...
 */
UCLASS(Abstract)
class ARCHITECTOFCREATION_API AAoCCharacterBase : public ACharacter, public IAbilitySystemInterface
{
	GENERATED_BODY()
